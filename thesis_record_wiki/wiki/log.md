...
* **Repair** | Traced and repaired the current analysis-agent T23A-to-T27 relationship-extraction bridge, added focused current-runtime tests, and recorded the remaining missing `en_core_web_sm` dependency-parsing caveat.
