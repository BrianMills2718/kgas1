...
* **Synthesis** | Added theory-schema/application lineage synthesis, connecting paper-to-schema extraction, model-form routing, schema variants, universal application, generated outputs, and validation caveats.
* **Synthesis** | Added uncertainty-framework consolidation, separating superseded ADRs, accepted entity-resolution design, stress-test implementations, preserved validation outputs, sensitive datasets, and current-status caveats.
...
* **Guide** | Added short reading guide with 15-minute, 60-minute, and deep-review paths through the thesis record wiki.
* **Verification** | Recorded full current-runtime live Neo4j rerun: 76 passed with six non-failing multi-record Neo4j driver warnings and no cleanup/deletion.
