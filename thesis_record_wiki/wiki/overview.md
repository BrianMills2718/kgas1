...
- [Digimon Lineage Reliability Tests](/wiki/sources/digimon-lineage-reliability-tests.md) - reliability test corpus preserving completed/in-progress/pending status boundaries, real-database tests, and certification ambitions.
...
- [Digimon Lineage Evidence Reports 2025 08](/wiki/sources/digimon-lineage-evidence-reports-2025-08.md) - curated August 2025 evidence bundle combining DAG/traceability success reports with relationship-extraction and coverage caveats.
- [Digimon Lineage Old Backups Results](/wiki/sources/digimon-lineage-old-backups-results.md) - old-backups output slice showing provenance traces, 7/7 Phase D integration report, 0/6 validation report, failed end-to-end workflow, and 22.2% tool-interface compliance audit.
- [Digimon Lineage Old Backups Current Coverage](/wiki/sources/digimon-lineage-old-backups-coverage-current.md) - broad old-backups `src/core` coverage report with 206 files and 2.99% total coverage.
- [Digimon Lineage Old Backups Validation Reports](/wiki/sources/digimon-lineage-old-backups-validation-reports.md) - skeptical Phase 2/Phase 3 validation reports separating structure, shallow tests, simulated processing, and functional completeness.
...
- [Digimon Lineage Old Backups Carter Analysis Output](/wiki/sources/digimon-lineage-old-backups-carter-analysis-output.md) - single old-backups Carter speech-analysis JSON with themes/rhetoric/insights and empty traceability evidence sidecars.
...
- [Digimon Lineage Old Backups Stress Test Root](/wiki/sources/digimon-lineage-old-backups-stress-test-root.md) - stress-test reports and machine outputs showing a 0.4-to-0.8 integration-score progression, unresolved cross-modal preservation, and a patched demonstration.
- [Digimon Lineage Old Backups Stress Test Framework](/wiki/sources/digimon-lineage-old-backups-stress-test-framework.md) - support framework for the same stress test, including schemas, theory JSON, registry/tool capability metadata, algorithms, config, and mock-mode caveats.
...
- [Digimon Lineage Uncertainty Stress Test Root](/wiki/sources/digimon-lineage-uncertainty-stress-test-root.md) - root uncertainty experiment docs/results with 5/5 IC stress-test pass claims, 75% external-evaluation readiness warning, Davis-enhanced validation claims, and bias caveats.
- [Digimon Lineage Uncertainty Stress Test Analysis](/wiki/sources/digimon-lineage-uncertainty-stress-test-analysis.md) - Davis methodology extraction and synthesis layer, including six-paper rapid analysis, 157 prepared chunks, six agent notes, and 3.8% coverage caveat.
...
- [KGAS Evolution Checkpoint 2026-06-25](/wiki/concepts/kgas-evolution-checkpoint-2026-06-25.md) - bounded synthesis after top-level archive coverage, naming the current KGAS evolution arc, remaining uncertainty, and recommended deep dives.
