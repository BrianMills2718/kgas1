...
[Digimon Lineage Old Backups Output Reports](/wiki/sources/digimon-lineage-old-backups-output-reports.md) adds a pass-rate-versus-implementation-status contrast: Phase A/B reports say all tests passed, while the tool-registry report says only 12 of 123 planned tools were implemented.
...
- Generated validation pass rates must be read alongside implementation inventory: old-backups Phase A/B reports claim 6/6 and 20/20 tests passed, while the paired tool-registry report says 12/123 tools implemented and 0% unified-interface adoption. [Digimon Lineage Old Backups Output Reports](/wiki/sources/digimon-lineage-old-backups-output-reports.md)
