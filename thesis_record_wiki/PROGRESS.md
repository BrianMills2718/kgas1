...
1. Next recommended step: build a richer `.txt` fixture that produces at least one T27 relationship/Neo4j edge, then use that as the acceptance test before wiring `/api/analyze`.
